...
const AdminRooms = (props) => {
  ...
  return (
    <div className="cont-admin-room">
      ...
      {showRoomCreate && (
        <CreateRoomForm show={showRoomCreate} handleClose={handleClose} />
      )}{" "}
      {/*  muestra componente para crear room */}
      {showEditRoom && (
        <EditRoomForm
          show={showEditRoom}
      ...
      {/*  muestra el componente para actualizar una room */}
      <DeleteUpdateRoom
        allRooms={allRooms}
        handleShowEditComponent={handleShowUpdateRoom}
        DelRoomSweet={DelRoomSweet}
      />
    </div>
  );
};
